...
-- Dumping data for table flt_2.flt_path_flight: ~3 rows (approximately)
...
-- Dumping data for table flt_2.flt_sub_flight: ~3 rows (approximately)
...
-- Dumping structure for table flt_2.flt_users
...
-- Dumping data for table flt_2.flt_users: ~10 rows (approximately)
